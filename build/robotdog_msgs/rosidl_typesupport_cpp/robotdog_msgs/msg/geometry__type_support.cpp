...
static const _Geometry_type_support_symbol_names_t _Geometry_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotdog_msgs, msg, Geometry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotdog_msgs, msg, Geometry)),
  }
};
...
{
  return &::robotdog_msgs::msg::rosidl_typesupport_cpp::Geometry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotdog_msgs, msg, Geometry)() {
  return get_message_type_support_handle<robotdog_msgs::msg::Geometry>();
}
