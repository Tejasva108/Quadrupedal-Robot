...
#include "robotdog_msgs/msg/detail/geometry__rosidl_typesupport_fastrtps_c.h"
...
using _Geometry__ros_msg_type = robotdog_msgs__msg__Geometry;
...
size_t get_serialized_size_robotdog_msgs__msg__Geometry(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Geometry__ros_msg_type * ros_message = static_cast<const _Geometry__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Geometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotdog_msgs__msg__Geometry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotdog_msgs
size_t max_serialized_size_robotdog_msgs__msg__Geometry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotdog_msgs__msg__Geometry;
    is_plain =
      (
...
static size_t _Geometry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotdog_msgs__msg__Geometry(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotdog_msgs, msg, Geometry)() {
