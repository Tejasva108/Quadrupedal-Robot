...
#ifndef ROBOTDOG_MSGS__MSG__DETAIL__GEOMETRY__TRAITS_HPP_
#define ROBOTDOG_MSGS__MSG__DETAIL__GEOMETRY__TRAITS_HPP_
...
inline void to_yaml(
  const robotdog_msgs::msg::Geometry & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const robotdog_msgs::msg::Geometry & msg)
{
  return robotdog_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<robotdog_msgs::msg::Geometry>()
{
  return "robotdog_msgs::msg::Geometry";
}

template<>
inline const char * name<robotdog_msgs::msg::Geometry>()
{
  return "robotdog_msgs/msg/Geometry";
}

template<>
struct has_fixed_size<robotdog_msgs::msg::Geometry>
...
template<>
struct has_bounded_size<robotdog_msgs::msg::Geometry>
...
template<>
struct is_message<robotdog_msgs::msg::Geometry>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROBOTDOG_MSGS__MSG__DETAIL__GEOMETRY__TRAITS_HPP_
