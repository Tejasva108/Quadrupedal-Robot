...
class Metaclass_KeyboardCtrlCmd(type):
    """Metaclass of message 'KeyboardCtrlCmd'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('robotdog_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'robotdog_msgs.msg.KeyboardCtrlCmd')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__keyboard_ctrl_cmd
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__keyboard_ctrl_cmd
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__keyboard_ctrl_cmd
            cls._TYPE_SUPPORT = module.type_support_msg__msg__keyboard_ctrl_cmd
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__keyboard_ctrl_cmd
...
class KeyboardCtrlCmd(metaclass=Metaclass_KeyboardCtrlCmd):
    """Message class 'KeyboardCtrlCmd'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.gait_type = kwargs.get(
            'gait_type', KeyboardCtrlCmd.GAIT_TYPE__DEFAULT)
        from geometry_msgs.msg import Pose
